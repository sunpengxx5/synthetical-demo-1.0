...
dbUrl=${dbUrl//\//\\\/}
dbUrl=${dbUrl//&/\\&}
dbConfigPath=/usr/local/tomcat/webapps/manager-node/WEB-INF/classes/config/component/dbservice.properties
sed -i 's/\(hostAndPort=\).*/\1'$dbUrl'/' $dbConfigPath

# Kafka config
kafkaConfigPath=/usr/local/tomcat/webapps/manager-node/WEB-INF/classes/config/component/kafka.properties
...
# Kafka client config
kafkaClientConfigPath=/usr/local/tomcat/webapps/manager-node/WEB-INF/classes/dms_kafka_client_jaas.conf
...
# Redis config
redisConfigPath=/usr/local/tomcat/webapps/manager-node/WEB-INF/classes/config/component/redis.properties
